function editTask(){
	...
	ass.innerHTML="<input type='text' list="user" > <datalist id ="user"> <option value = "Batman"> <option value = "Robin"> <option value = "Nightwing"> <option value = "Red Robin"> <option value = "Red Hood"> <option value = "Batgirl"> <option value = "Catwoman"> <option value = "Huntress"> <option value = "Alfred"> </datalist>";
